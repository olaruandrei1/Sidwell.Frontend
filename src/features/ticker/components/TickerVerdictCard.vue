...
<template>
  ...
  >
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      >
        <span class="text-terminal-accent font-bold">Risk may be worth it</span>
        <span class="text-gray-500">—</span>
        <span class="text-emerald-400 font-bold">~{{ verdict.probabilisticWin }}% win probability</span>
      </div>
    </div>
  </div>
</template>
