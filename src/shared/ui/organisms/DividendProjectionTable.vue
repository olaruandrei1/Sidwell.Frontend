...
const hasHistoric = computed(() => {
  ...
  return props.projection.scenarios.some((s) => s.cumulativeHistoric !== null);
});
        ...
        <tbody class="divide-y divide-white/5 font-mono text-sm">
          ...
          >
            ...
            <td class="px-4 py-2.5 text-right font-semibold">
              <MoneyText :value="row.cumulativeConservative" currency="RON" :places="2" />
            </td>
            <td class="px-4 py-2.5 text-right font-semibold">
              <MoneyText :value="row.cumulativeModerate" currency="RON" :places="2" />
            </td>
            <td v-if="hasHistoric" class="px-4 py-2.5 text-right font-semibold">
              <MoneyText :value="row.cumulativeHistoric" currency="RON" :places="2" />
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        ...
        <div class="space-y-2 text-xs font-mono">
          <div class="flex items-center justify-between">
            ...
            <MoneyText :value="row.cumulativeConservative" currency="RON" :places="2" class="font-bold" />
          </div>
          <div class="flex items-center justify-between">
            <span class="text-gray-400">Moderat (8%)</span>
            <MoneyText :value="row.cumulativeModerate" currency="RON" :places="2" class="font-bold" />
          </div>
          <div v-if="hasHistoric" class="flex items-center justify-between border-t border-white/10 pt-1.5">
            ...
            <MoneyText :value="row.cumulativeHistoric" currency="RON" :places="2" class="font-bold text-emerald-400" />
          </div>
        </div>
      </div>
    </div>
